...
Returns a promise for the string containing the value of the device identifier of the directory API (e.g., [Directory API for Chrome devices](https://developers.google.com/admin-sdk/directory/v1/guides/manage-chrome-devices)), that is generated by the server and identifies the cloud record of the device for querying in the cloud directory API.
